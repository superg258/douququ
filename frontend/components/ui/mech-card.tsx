...
const MechCard = React.forwardRef<HTMLDivElement, MechCardProps>(
  ({ className, variant = "default", label, children, ...props }, ref) => {
    ...
    const variantStyles = {
      ...
      red: "border-rm-red bg-rm-red-dim text-rm-red backdrop-blur-md shadow-[0_0_15px_rgba(232,48,42,0.2)]",
      blue: "border-rm-blue bg-rm-blue-dim text-rm-blue backdrop-blur-md shadow-[0_0_15px_rgba(42,159,255,0.2)]",
      safe: "border-rm-status-safe bg-rm-status-safe/10 text-rm-status-safe backdrop-blur-md shadow-[0_0_15px_rgba(0,232,120,0.2)]",
    };
