          ...
          <table className="w-full text-left border-collapse text-xs">
            <thead>
              <tr className="border-b border-rm-metal-border text-rm-metal-textFaint font-mono text-[10px] uppercase tracking-widest bg-rm-metal-dark/40">
                ...
                <th className="py-3 px-4 font-bold text-right">四强均战力</th>
                <th className="py-3 px-4 font-bold text-right">八强均战力</th>
                <th className="py-3 px-4 font-bold text-right">中位战力</th>
